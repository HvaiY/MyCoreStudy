...
using Abp.UI;
using MyFirstABPProject.Authentication.External;
...
using MyFirstABPProject.Models.TokenAuth;
using MyFirstABPProject.MultiTenancy;

namespace MyFirstABPProject.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : MyFirstABPProjectControllerBase
    {
